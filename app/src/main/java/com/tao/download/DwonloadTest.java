...
public class DwonloadTest {
    ...
    public static void main(String[] args) {
        ...
        DownloadCall downloadCall = new DownloadCall() {
            private String tag = "";
...
//        DownloadHelper.getInstance().addDownload("http://dl.2345.com/haozip/2345haozip_6.2.0.11032_setup.exe", downloadCall);
